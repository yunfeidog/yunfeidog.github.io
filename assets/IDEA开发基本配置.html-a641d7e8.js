import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as t}from"./app-543248b1.js";const e={},p=t(`<h1 id="idea开发基本配置" tabindex="-1"><a class="header-anchor" href="#idea开发基本配置" aria-hidden="true">#</a> IDEA开发基本配置</h1><p>配置jar包输入位置直接到服务端的plugin目录下：</p><p>主要是配置outputDirectory为自己的服务端plugin位置</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token generics"><span class="token punctuation">&lt;</span>properties<span class="token punctuation">&gt;</span></span>
