import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as i,a as s}from"./app-543248b1.js";const a={},l=s(`<h1 id="用户中心" tabindex="-1"><a class="header-anchor" href="#用户中心" aria-hidden="true">#</a> 用户中心</h1><p>部署上面的优化：</p><p>这些把前端也通过打包的方式进行构建，每次修改页面之后都要重新打包构建一个镜像，不方便动态的修改页面</p><p>考虑使用数据卷挂载的方式来启动docker</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-p</span> <span class="token number">80</span>:80 <span class="token parameter variable">-d</span> <span class="token parameter variable">--name</span> user-center-frontend <span class="token punctuation">\\</span>
